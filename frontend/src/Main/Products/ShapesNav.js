    ...
    return (
        <>
            <div className="application">
                <Helmet>
                    <meta charSet="utf-8" />
                    <title>PentagonPackaging - ShapesAndStyle</title>
                    <link rel="canonical" href={`${Env.link}/ShapesAndStyle`} />
                    <meta
                        name="description"
                        ...
                        <div className="row type-cat m-5" id="allproduct-section">
                            {GetProduct.map(product => (
                                <div key={product._id} className="col-md-3 col-sm-6 mb-4">
                                    <div onClick={() => singlcomponent(product.shape, product.title)} className="section-type-box" style={{ height: "440px", width: "100%" }}>
                                        <a>
                                            <img
