...
const Other = () => {
    ...
    const updateAllData = (imgFileName) => {
        ...
        axios.patch(`${Env.server}/api/other/updateData`, data)
            .then((resp) => {
                let res = resp.data.industries;
    ...
    const publishBlogNow = (imgFileName) => {
        ...
        axios.post(`${Env.server}/api/other/addNew`, data)
            .then((res) => {
    ...
    const ConfirmedDeleteBlog = () => {
        axios.delete(`${Env.server}/api/other/deleteOne/${deleteBlogId}`)
            .then((res) => {
        ...
        <div className="bg-white" style={{ backgroundColor: "white" }} >
            <div className=" d-flex" style={{ marginTop: "100px" }} >
                ...
                <div className="container d-flex justify-content-start mt-3">
                    <button className="ButtonDesgin" onClick={() => setIndustriesModalOpen(true)} style={{ backgroundColor: "#209abc", color: "white" }}>Others</button>
                </div>
                <div className="container d-flex justify-content-end mt-3">
                    <button className="ButtonDesgin" onClick={() => setIndustriesModalOpen(true)} style={{ backgroundColor: "#209abc", color: "white" }}>Add Data</button>
                </div>
            </div>
