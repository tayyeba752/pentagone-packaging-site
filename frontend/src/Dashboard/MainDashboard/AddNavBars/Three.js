...
const Three = () => {
    ...
    const [getRespShape, setGetRespShape] = useState([]);
    ...
    const getAllDataForUpdate = (shape) => {
        axios.get(`${Env.server}/api/shape/getOne/${shape}`)
            .then((resp) => {
                let res = resp.data.shapes[0];
                setTitle(res.title);
                setShapeStyle(res.shape);
    ...
    const getShapeStyleAll = () => {
        axios.get(`${Env.server}/api/shape/getAll`)
            .then((resp) => {
                let res = resp.data.shapes;
                setGetRespShape(res);
            })
            .catch((err) => {
                console.log("err", err);
    ...
    const publishBlogNow = (imgFileName) => {
        ...
        axios.post(`${Env.server}/api/shape/AddNew`, data)
            .then((res) => {
    ...
    const updateAllData = (imgFileName) => {
        ...
        axios.patch(`${Env.server}/api/shape/updateData`, data)
            .then((resp) => {
                let res = resp.data.shapes;
    ...
    const ConfirmedDeleteBlog = () => {
        axios.delete(`${Env.server}/api/shape/deleteOne/${deleteBlogId}`)
            .then((res) => {
        ...
        <div className="bg-white" style={{ backgroundColor: "white" }}>
            ...
            <div className=" d-flex"  >
                ...
                <div className="container d-flex justify-content-start mt-3">
                    <button className="ButtonDesgin" onClick={() => setIndustriesModalOpen(true)} style={{ backgroundColor: "#209abc", color: "white" }}>Shapes ans Style</button>
                </div>
                <div className="container d-flex justify-content-end mt-3">
                    <button className="ButtonDesgin" onClick={() => setIndustriesModalOpen(true)} style={{ backgroundColor: "#209abc", color: "white" }}>Add Shapes Data</button>
                </div>
            </div>
                                    ...
                                    <div class="row g-0" style={{ height: "80px" }}>
                                        ...
                                        <div class="col-md-8 d-flex" >
                                            ...
                                            &nbsp; &nbsp; <div onClick={() => {
                                                ...
                                                getAllDataForUpdate(data.shape);
                    ...
                    >
                        ...
                        <center>
                            ...
                            <Typography id="modal-title" variant="h4" component="h2">
                                ...
                                {clickEditModal ? (
                                    <>
                                        <b>Update Shapes Data</b>
                                    </>
                                ) : (
                                    <>
                                        <b>Add new Shapes Data</b>
                                    </>
                                )}
                            </Typography>
                            <Container>
                                ...
                                <FormControl style={{ minWidth: '100%', marginTop: "10px" }}>
                                    ...
                                    >
                                        <MenuItem value="01">Sleeve</MenuItem>
                                        <MenuItem value="02">Hang tab</MenuItem>
                                        <MenuItem value="03">Pillow</MenuItem>
                                        <MenuItem value="04">Gable</MenuItem>
                                        <MenuItem value="05">Handle</MenuItem>
                                        <MenuItem value="06">Display</MenuItem>
                                    </Select>
                                </FormControl>
